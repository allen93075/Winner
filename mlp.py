# -*- coding: utf-8 -*-
"""
Created on Sat May  9 19:36:31 2020
此檔案為訓練模型檔案
@author: user
"""
...
#載入資料
def loadFile(path='E:\ProjectAI\TXF1 1 小時10年.csv'):
...
def mlp_main(data):
    ...
    #設定模型
    mlp_ai = MLPClassifier(hidden_layer_sizes=(1,100), max_iter=500, alpha=1e-4,
    ...
    #print('acc：%s' % mlp_ai.score(X_test, y_test))
    ...
    #保存模型
    #joblib.dump(mlp_ai, "mlp_train_model.pkl")
