...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.BackHome_button.setStyleSheet("border-color: rgba(255, 255, 255, 0);\n"
"background-color: rgba(255, 255, 255, 0);")
        self.BackHome_button.setText("")
        self.BackHome_button.setObjectName("BackHome_button")
        self.verticalLayout_3.addWidget(self.BackHome_button)
        spacerItem = QtWidgets.QSpacerItem(20, 10, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_3.addItem(spacerItem)
        self.MCcall_button = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.MCcall_button.sizePolicy().hasHeightForWidth())
        self.MCcall_button.setSizePolicy(sizePolicy)
        self.MCcall_button.setStyleSheet("border-color: rgba(255, 255, 255, 0);\n"
"background-color: rgba(255, 255, 255, 0);")
        self.MCcall_button.setText("")
        self.MCcall_button.setObjectName("MCcall_button")
        self.verticalLayout_3.addWidget(self.MCcall_button)
        spacerItem1 = QtWidgets.QSpacerItem(20, 10, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.verticalLayout_3.addItem(spacerItem1)
        self.PLcall_button = QtWidgets.QPushButton(self.centralwidget)
        self.PLcall_button.setStyleSheet("border-color: rgba(255, 255, 255, 0);\n"
"background-color: rgba(255, 255, 255, 0);")
        self.PLcall_button.setText("")
        self.PLcall_button.setObjectName("PLcall_button")
        self.verticalLayout_3.addWidget(self.PLcall_button)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 338, 541))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionHomepage.setText(_translate("MainWindow", "返回主頁"))
