...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.performance_data_combobox = QtWidgets.QComboBox(Form)
        self.performance_data_combobox.setObjectName("performance_data_combobox")
        self.horizontalLayout_2.addWidget(self.performance_data_combobox)
    ...
    def retranslateUi(self, Form):
        ...
        self.title.setText(_translate("Form", "RangeBreak"))
        self.label_9.setText(_translate("Form", "選擇績效資料"))
        self.performancedata_toolButton.setText(_translate("Form", "..."))
